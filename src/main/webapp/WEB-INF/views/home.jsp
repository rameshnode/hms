<div>
	<h1>Welcome to Java case study for Hotel Booking (11069081)</h1>
	<p>
	...
	<ul>
		...
		<li>Junit test cases for all service class</li>
		...
		<li>Use of hibernate hql to fetch and save the data in HSQL in-memory database</li>
	</ul>
	<p>
		<a href="hotels/search">Start your case study experience</a>
	</p>
</div>
